(() => {
    ...
    function initSliders() {
        if (document.querySelector(".case__body")) new core(".case__body", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 2.5,
        ...
        if (window.matchMedia("(max-width: 480px)").matches) if (document.querySelector(".problems__body")) new core(".problems__body", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".benefits-main__body")) new core(".benefits-main__body", {
        ...
        if (document.querySelector(".video-slider__body")) new core(".video-slider__body", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
